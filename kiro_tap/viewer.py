...
try:
    KIRO_TAP_VERSION = _pkg_version("kiro-tap")
except Exception:
    KIRO_TAP_VERSION = "0.0.0"
...
def _viewer_i18n_script() -> str:
    ...
    return f"const __KIRO_TAP_I18N__ = {payload};\n"
...
def _generate_html_viewer(
    ...
    *,
    ...
    version_js = json.dumps(KIRO_TAP_VERSION)
    ...
    if use_lazy:
        ...
        data_js = (
            ...
            f"const __KIRO_TAP_VERSION__ = {version_js};\n"
        )
