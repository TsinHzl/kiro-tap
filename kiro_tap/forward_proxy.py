...
man-in-the-middle TLS termination. This allows kiro-tap to intercept
HTTPS traffic while Kiro uses the real api.anthropic.com endpoint
...
class ForwardProxyServer:
    ...
    async def _handle_streaming(
        ...
        if "application/vnd.amazon.eventstream" in content_type:
            reassembler = AWSEventStreamReassembler(store_events=self._store_stream_events)
        else:
